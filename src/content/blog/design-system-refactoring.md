...
문제는 한 컴포넌틔에 너무 많은 기능 있어 발생하기도 했습니다. 테이블 컴포넌트의 경우가 대표적입니다.
...
이로 인해 코드를 이해하려면 여러 폴더를 전부 뒤져야 했고, 관련 변경을 할 때마다 프로젝트 전반을 서치해야 하는 비효율이 계속 발생했습니다.
...
또한, 디자인 시스템을 개편하면서 변경/추가된 공통 컴포넌트에 다수 존재했는데, 스토리북을 통해 빠르게 피드백을 받을 수 있었으며, 소통 시간또한 감소시킬 수 있었습니다.
